...
import UserslistTable from '../app/modules/usersandroles/feature/Users/usersList/subfeatures/userListTable';
...
export const Routes= function(props){
    ...
    <Switch>
        ...
        <Route exact path='/userlist' component={UserslistTable} />
